...
console.log('✨ Welcome to the Φ-Chain revolution! ✨');
console.log('Built by BadreddineBaha');
console.log('GitHub: https://github.com/badreddine023/phi-chain');
